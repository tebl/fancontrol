...
def main():
    ...
    '''
    parser.add_argument('-c', '--config-path', type=utils.is_ini, default='fancontrol.ini', help='Specify configuration')
    parser.add_argument('-i', '--import-path', type=utils.is_config, default="/etc/fancontrol", help='Specify configuration')
